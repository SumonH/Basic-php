    ...
    <section class="maincontent">
      ...
      <?php
        /*setcookie(
          name, //cookies name
         value, // information
         expire, //time fixed then being delete utomaticli
         path, //that deroctori come cookie
         domain, //that for domain its cookie
         secure, //just value 0 or 1
         httponly) //true of false*/
